      ...
      <div className="w-full max-w-md">
        ...
        <Card className="space-y-6">
          <div className="text-center p-4 bg-slate-800/30 rounded-lg">
            ...
            <p className="text-sm text-slate-400">Supervisor: {team.supervisor}</p>
          ...
          <button
            onClick={onGoBack}
            className="w-full flex items-center justify-center gap-2 p-3 text-slate-400 hover:text-white transition-colors"
          >
